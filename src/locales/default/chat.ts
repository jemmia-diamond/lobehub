export default {
  ...
  'members': 'Members',
  'mention.larkDocs': 'Recent Documents',
  'mention.larkUsers': 'Recent Interactors',
  ...
  'messageAction.feedback': 'Submit Feedback',
  'messageAction.feedbackNegative': 'Bad response',
  'messageAction.feedbackPositive': 'Good response',
  ...
  'lark.dateViewed': 'Date Viewed',
  'lark.docDetail': 'Owner: {{owner}} | Type: {{type}}',
  'lark.docType.bitable': 'Bitable',
  'lark.docType.doc': 'Doc',
  'lark.docType.file': 'File',
  'lark.docType.folder': 'Folder',
  'lark.docType.mindnote': 'Mindnote',
  'lark.docType.sheet': 'Sheet',
  'lark.docType.slide': 'Slide',
  'lark.docType.unknown': 'Unknown',
  'lark.docs': 'Docs',
  'lark.wiki': 'Wiki',
  'lark.attaching': 'Attaching...',
  'lark.filter.allFormats': 'All Formats',
  'lark.filter.allSpaces': 'All Spaces',
  'lark.filter.dateViewed': 'Date Viewed',
  'lark.filter.format': 'Format',
  'lark.filter.from': 'From',
  'lark.filter.inFolder': 'In folder',
  'lark.filter.inWiki': 'In wiki space',
  'lark.filter.sharedIn': 'Shared in',
  'lark.filter.sort': 'Sort',
  'lark.filter.viewed': 'Recently Viewed',
  'lark.filter.updated': 'Recently Updated',
  'lark.filter.created': 'Recently Created',
  'lark.filter.source': 'Source',
  'lark.filter.title': 'Filters',
  'lark.helpAndFeedback': 'Help and Feedback',
  'lark.noDocsFound': 'No documents found',
  'lark.searchDocs': 'Search Wiki & Documents',
  'lark.searchDocsByOwner': 'Search Docs by owner...',
  'lark.searchGroups': 'Search groups...',
  'lark.toNavigate': 'to navigate',
  'lark.toQuit': 'to quit',
  'lark.toSelect': 'to select',
  'lark.typeToSearch': 'Type to search documents...',
  'lark.untitledDoc': 'Untitled Document',
  'larkSelectAction': 'Choose directly from Lark',
  'jemmia.model.flash': 'Think Deeply',
  'jemmia.model.lite': 'Quick Work',
  'jemmia.model.pro': 'Expert',
  'sendPlaceholder': 'Enter your request or drag and drop files here...',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of Brainy. Brainy is not responsible for any consequences arising from this shared content.',
