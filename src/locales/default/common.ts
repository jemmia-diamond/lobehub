export default {
  ...
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Brainy Cloud.',
  ...
  'feedback.widget.buttonLabel': 'Feedback',
  ...
  'feedback.widget.nameLabel': 'Full Name',
  'feedback.widget.namePlaceholder': 'Enter your name',
  'feedback.widget.submitButtonLabel': 'Send',
  'feedback.widget.successMessage': 'Thank you for your feedback!',
