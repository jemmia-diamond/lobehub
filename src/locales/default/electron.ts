export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Jemmora server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Jemmora Cloud',
