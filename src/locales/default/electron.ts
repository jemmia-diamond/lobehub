export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Brainy server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Brainy Cloud',
