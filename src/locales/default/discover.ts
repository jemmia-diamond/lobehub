export default {
  ...
  'createGuide.func1.title': 'Submit in Jemmora',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Jemmora Community.',
  'footer.title': 'Share your creation on Jemmora Community today',
  ...
  'models.providerInfo.apiTooltip': 'Jemmora supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Jemmora Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Jemmora automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Jemmora marketplace with one click.',
