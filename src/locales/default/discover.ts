export default {
  ...
  'createGuide.func1.title': 'Submit in JemOS',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the JemOS Community.',
  'footer.title': 'Share your creation on JemOS Community today',
  ...
  'models.providerInfo.apiTooltip': 'JemOS supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'JemOS Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Trợ lý JemX',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by JemOS automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the JemOS marketplace with one click.',
