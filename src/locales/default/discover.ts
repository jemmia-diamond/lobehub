export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>tech@jemmia.vn</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>tech@jemmia.vn</email>.',
  ...
  'createGuide.func1.title': 'Submit in Brainy',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Brainy Community.',
  'footer.title': 'Share your creation on Brainy Community today',
  ...
  'models.providerInfo.apiTooltip': 'Brainy supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Brainy Official Service',
  ...
  'skills.details.sidebar.agent.useOnLobeAI': 'Use on Brainy',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Brainy automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Brainy marketplace with one click.',
