export default {
  ...
  'memory.enabled.desc':
    'Allow Jemmora to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'skillStore.tabs.lobehub': 'Jemmora',
