export default {
  ...
  'memory.enabled.desc':
    'Allow JemOS to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
