export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Jemmora Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Jemmora. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Jemmora',
  ...
  'screen5.actions.signInCloud': 'Sign in to Jemmora Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Jemmora Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Jemmora Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Jemmora server instance',
