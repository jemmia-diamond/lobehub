export default {
  ...
  'authResult.success.desc': 'Please click the Start button below to continue using JemOS Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve JemOS. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve JemOS',
  ...
  'screen5.actions.signInCloud': 'Sign in to JemOS Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your JemOS Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'JemOS Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own JemOS server instance',
