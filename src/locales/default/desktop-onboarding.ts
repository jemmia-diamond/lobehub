export default {
  ...
  'authResult.success.desc': 'Please click the Start button below to continue using Brainy Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Brainy. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Brainy',
  ...
  'screen5.actions.signInCloud': 'Sign in to Brainy Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Brainy Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Brainy Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Brainy server instance',
