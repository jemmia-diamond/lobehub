export default {
  ...
  'builtins.lobe-agent-management.inspector.getAgentDetail.title': 'Getting agent detail:',
  ...
  'builtins.lobe-agent-management.render.installPlugin.success': 'Plugin installed successfully',
  'builtins.lobe-agent-management.render.installPlugin.failed': 'Plugin installation failed',
  ...
  'protocolInstall.official.badge': 'Brainy Official Skill',
  'protocolInstall.official.description': 'Official Brainy Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Brainy does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.title': 'Add skills to Brainy',
