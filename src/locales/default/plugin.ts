export default {
  ...
  'protocolInstall.official.badge': 'Jemmora Official Skill',
  'protocolInstall.official.description': 'Official Jemmora Skill, verified and security-checked.',
